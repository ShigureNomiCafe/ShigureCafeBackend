...
import cafe.shigure.ShigureCafeBackend.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/logs", "/api/v1/logs/**").hasAnyAuthority("ADMIN", "API_CLIENT")
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/registrations/**").hasAnyAuthority("ADMIN", "API_CLIENT")
